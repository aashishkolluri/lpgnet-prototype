...
Running attack needs all the options used for training and a few more options in addition such as the attack_mode and sample_type (samples for evaluation).
