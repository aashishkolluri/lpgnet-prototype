...
We provide a prototype of Link Private Graph Networks (LPGNet) that can be used to for semi-supervised node classification with edge differential privacy. Please read our [paper](https://arxiv.org/abs/2205.03105) for more information.
